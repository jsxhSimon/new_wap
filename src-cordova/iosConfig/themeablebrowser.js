...
exports.open = function(strUrl, strWindowName, strWindowFeatures, isFullScreen, callbacks) {
    ...
    setTimeout(function() {
        exec(cb, cb, 'ThemeableBrowser', 'open', [strUrl, strWindowName, strWindowFeatures || '', isFullScreen]);
    }, 0);
    return iab;
};
